<template>
    <div>
        <el-row style="margin-left: 230px">
            <el-col :span="3">
         ...
         return {
             movieList:[
                 [
                     ...
                     {title:'我在你床下',score:'6.7',imgUrl:require('../assets/4.jpg')},
                     {title:'酷刑报告',score:'7.0',imgUrl:require('../assets/5.jpg')}
                 ],
                 [
