<template>
  <div id="app">
    ...
    <!--</div>-->
    <!--&lt;!&ndash;router-view其实就是页面变化的具体内容所在的位置，例如：home切换到about&ndash;&gt;-->
    <!--&lt;!&ndash;要使用动画，请将router-view用transition标签包裹起来,appearActiveClass用于设置想要用什么动画，设置-->
    <!--的是第一次出现页面时的动画，enterActiveClass：用于设置页面切换时动画&ndash;&gt;-->
